    ...
    namespace scalar_impl
    {
            ...
            float delta)
        {
            ...
            for (; i < mul8; i += 8)
            {
                ...
                // AVX2 alternative: pack 8x32-bit to 8x16-bit manually
                // Extract lower and upper 128-bit halves
                __m128i lo128 = _mm256_castsi256_si128(i32);
                __m128i hi128 = _mm256_extracti128_si256(i32, 1);
                // Pack 4+4 32-bit ints to 8x16-bit (saturated)
                __m128i i16 = _mm_packs_epi32(lo128, hi128);
                // Store 8x16-bit integers
